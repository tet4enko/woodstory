                ...
                <div className="content-wrapper">
                    ...
                    <div className="comments">
                        ...
                        <div className="secondary">
                            {comment('Василий', 42, 'Заказывал картину на юбилей свадьбы для любимой жены, она была восторге и мне тоже очень понравилось, всем рекомендую, очень оригинальный подарок к любому празднику!!!', vasiliy, 'right', 'https://instagram.com/dmitry_tetchenko/')}
                            ...
                            {comment('Дмитрий', 23, 'Всем здравствуйте, хочу поблагодарить всю команду Wood Story за оперативность, выполнили все очень быстро, красиво упаковали, доставили до двери. Рекомендую всем, очень красивый подарок для ваших родных и близких :)', dmitriy, 'right', 'https://instagram.com/dmitry_tetchenko/')}  
                        </div>
                    </div>
                </div>
            </div>
